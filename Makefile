...
OUTPUT_DIR="./out"
OUTPUT_NAME = eddie
DEBUG_FLAGS = -D VSCODE -D DEBUG -ggdb
VERBOSE_FLAGS = -D DEBUG_PRINTS
...
debug: $(C_FILES)
	$(CC) $(C_FILES) -o $(OUTPUT_DIR)/$(OUTPUT_NAME) $(CFLAGS) $(MATH_FLAGS) $(DEBUG_FLAGS) $(VERBOSE_FLAGS)

silent_debug: $(C_FILES)
